...
function fakeApi(overrides: Record<string, unknown> = {}): ApiClient {
  ...
  const table: Record<string, unknown> = {
    ...
    '/api/stocks/kline': { symbol: 's', market: 'cn', name: 'n', currency: 'CNY', candles: [{ timestamp: 1, open: 1, high: 2, low: 0.5, close: 1.5, volume: 100 }], indicators: { ma: {}, macd: { dif: [], dea: [], macd: [] }, kdj: { k: [], d: [], j: [] } }, as_of: null, fetched_at: null },
    '/api/stocks/etf/kline': { symbol: 's', market: 'etf', name: 'n', currency: 'CNY', candles: [{ timestamp: 1, open: 1, high: 2, low: 0.5, close: 1.5, volume: 100 }], indicators: { ma: {}, macd: { dif: [], dea: [], macd: [] }, kdj: { k: [], d: [], j: [] } }, as_of: null, fetched_at: null, adjust_note: '不复权' },
