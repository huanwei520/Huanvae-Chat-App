...
export const CHAT_COMPONENTS: ComponentEntry[] = [
  ...
  { name: 'JoinPolicyForm', path: 'chat/shared/menu/JoinPolicyForm', category: 'chat', description: '入群与可见性设置（仅群主；审核/管理员两开关 + 加群三开关 + 三档 scope，只发被改的键、不做乐观更新）' },
  { name: 'GroupQrView', path: 'chat/shared/menu/GroupQrView', category: 'chat', description: '群二维码（本群成员；payload 只能来自服务端，本地拼串会绕过 qr_show_scope）' },
