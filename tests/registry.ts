...
export const HOOKS: ComponentEntry[] = [
  ...
  { name: 'useFriendReadReceipt', path: 'chat/friend/useFriendReadReceipt', category: 'hooks', description: '私聊已读回执 Hook（订阅对方已读时间，判定最后一条已读/未读）' },
  { name: 'useGroupReadReceipt', path: 'chat/group/useGroupReadReceipt', category: 'hooks', description: '群聊已读回执 Hook（read-positions 快照 + read_sync 实时合并，统计 N 人已读）' },
